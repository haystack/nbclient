...
export default {
    ...
    methods: {
        onClick: function () {
            this.$emit('log-nb', 'CLICK', 'LIST', this.thread.spotlight ? this.thread.spotlight.type.toUpperCase() : 'NONE',  this.thread.isSync, this.thread.hasSync, this.thread.id, this.thread.countAllReplies())
